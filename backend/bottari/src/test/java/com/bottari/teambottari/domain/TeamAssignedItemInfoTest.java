...
class TeamAssignedItemInfoTest {
    ...
    @DisplayName("이미 체크 되어있는 팀 담당 보따리 물품을 체크하면, 예외를 던진다.")
    @Test
    void check_Exception_AlreadyCheck() {
        ...
        final TeamAssignedItem teamSharedItem = new TeamAssignedItem(teamSharedItemInfo, teamMember);
        teamSharedItem.check();
    ...
    @DisplayName("팀 담당 보따리 물품을 체크 해제한다.")
    @Test
    void uncheck() {
        // given
        final Member member = new Member("ssaid", "name");
    ...
    @DisplayName("이미 체크 해제되어있는 팀 담당 보따리 물품을 체크 해제하면, 예외를 던진다.")
    @Test
