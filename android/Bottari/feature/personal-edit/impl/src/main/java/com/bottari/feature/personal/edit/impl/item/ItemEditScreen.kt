...
import com.bottari.feature.personal.edit.impl.item.component.ItemEditEmptyView
import com.bottari.feature.personal.edit.impl.item.component.ItemEditLazyColumn
...
fun PersonalItemEditScreen(
    ...
    viewModel: PersonalItemEditViewModel =
        hiltViewModel<PersonalItemEditViewModel, PersonalItemEditViewModel.Factory> {
            it.create(bottariId)
        },
) {
