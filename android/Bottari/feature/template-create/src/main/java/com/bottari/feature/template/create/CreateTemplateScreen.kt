...
import com.bottari.feature.template.create.component.TemplateDescriptionSection
import com.bottari.feature.template.create.component.TemplateHashtagSection
...
private fun CreateTemplateScreen(
    ...
    Column(modifier = Modifier.imePadding().fillMaxSize()) {
        CreateTemplateTopApp(onClickBack)
        Column(
            modifier =
                Modifier
                    .fillMaxSize()
