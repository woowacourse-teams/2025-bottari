package com.bottari.feature.template.impl
...
import com.bottari.feature.template.impl.bookmark.BookmarkTemplateScreen
import com.bottari.feature.template.impl.main.MainTemplateScreen
import com.bottari.feature.template.impl.my.MyTemplateScreen
...
fun TemplateScreen(
    ...
    TemplatePager(
        ...
        modifier = Modifier.padding(top = BottariTheme.spacing.spaceMedium),
    ) { page ->
        when (page) {
            0 -> {
                MainTemplateScreen(
...
private fun TemplateScreenPreview() {
    BottariTheme {
        TemplateScreen(
            snackbarState = SnackbarHostState(),
            navigateToTemplateDetail = { _, _, _ -> },
