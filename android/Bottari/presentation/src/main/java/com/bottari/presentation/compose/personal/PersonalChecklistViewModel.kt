...
import com.bottari.di.usecase.BottariItemUseCaseProvider.fetchItemsUseCase
import com.bottari.di.usecase.BottariItemUseCaseProvider.resetItemsCheckStateUseCase
import com.bottari.di.usecase.BottariItemUseCaseProvider.updateItemCheckStateUseCase
import com.bottari.di.usecase.TooltipUseCaseProvider.fetchTooltipStatusUseCase
import com.bottari.di.usecase.TooltipUseCaseProvider.updateTooltipStatusUseCase
...
class PersonalChecklistViewModel(
        ...
        fun Factory(bottariId: Long): ViewModelProvider.Factory =
            viewModelFactory {
                initializer {
                    ...
                    PersonalChecklistViewModel(
                        stateHandle,
                        fetchItemsUseCase,
                        fetchTooltipStatusUseCase,
                        updateTooltipStatusUseCase,
                        updateItemCheckStateUseCase,
                        resetItemsCheckStateUseCase,
                    )
                }
            }
    }
