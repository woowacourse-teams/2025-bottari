...
data class TeamBottariAlarmFetchResponse(
    ...
    @SerialName("location")
    val location: TeamBottariAlarmLocationResponse?,
    @SerialName("routine")
    val routine: TeamBottariAlarmRoutineResponse,
) {
    fun toDomain(): Alarm =
        Alarm(
            id = id,
...
@Serializable
data class TeamBottariAlarmLocationResponse(
    @SerialName("isActive")
    val isActive: Boolean,
    @SerialName("latitude")
    val latitude: Double,
...
@Serializable
data class TeamBottariAlarmRoutineResponse(
    @SerialName("date")
