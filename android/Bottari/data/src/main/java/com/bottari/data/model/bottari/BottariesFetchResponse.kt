...
data class BottariesAlarmFetchResponse(
    ...
    @SerialName("location")
    val location: BottariesAlarmLocationResponse?,
    @SerialName("routine")
    val routine: BottariesAlarmRoutineResponse,
)

@Serializable
data class BottariesAlarmLocationResponse(
    @SerialName("isActive")
    val isActive: Boolean,
    @SerialName("latitude")
    val latitude: Double,
...
@Serializable
data class BottariesAlarmRoutineResponse(
    @SerialName("date")
