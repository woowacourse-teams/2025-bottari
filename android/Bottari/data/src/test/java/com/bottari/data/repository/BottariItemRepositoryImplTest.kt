...
class BottariItemRepositoryImplTest {
    ...
    @Test
    fun fetchChecklistSuccessReturnsMappedDomainList() = runTest {
        // given
        val ssaid = "ssaid1234"
        val bottariId = 1L
    ...
    @Test
    fun returnFailureIfLoadChecklistFails() = runTest {
        // given
    ...
    @Test
    fun checkItemSuccessReturnsSuccess() = runTest {
        // given
        val ssaid = "ssaid123"
        val itemId = 10L
    ...
    @Test
    fun returnFailureIfCheckItemFails() = runTest {
        // given
        val ssaid = "ssaid123"
        val itemId = 10L
    ...
    @Test
    fun uncheckItemSuccessReturnsSuccess() = runTest {
        // given
        val ssaid = "ssaid123"
        val itemId = 11L
    ...
    @Test
    fun returnFailureIfUncheckItemFails() = runTest {
        // given
        val ssaid = "ssaid123"
        val itemId = 11L
